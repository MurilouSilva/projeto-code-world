/**
 * CODEWORLD // script.js
 * Gerenciador de interações de Menu Hambúrguer, Acessibilidade e Preferências do Usuário
 */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /**
   * Função auxiliar para alternar o estado ativo entre botões de um grupo
  ...
  // Aplica as preferências armazenadas ao carregar a página
